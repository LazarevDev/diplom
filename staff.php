        ...
        <div class="content spaceBetween" style="padding: 0;">
            ...
            <div class="contentWhite contentForm">
                ...
                <form action="" method="post" class="form">
                    ...
                    <input type="text" class="input" placeholder="Фиксированная заработная плата сотрудника в месяц">
                    <input type="number" class="input" placeholder="Процент от проданного товара">
